...
sucess = Library.TEXT("SUCCESED", "Game Asset\\ninja-naruto.regular.ttf", 100, "Black", "center", 500, 300)
go_button = Library.BUTTON((40, 40),"Blue", (100, 510))
change_direct_button = Library.BUTTON((40, 40),"Red", (180, 510))
compile_button = Library.ENVIROMENT("Game Asset\\Sound_on.png", 1.5, "center", 810, 370)
...
map_element_1 = Library.MAP_LAYOUT("Game Asset\\Map\\First_map_layout.txt", 25, "Game Asset\\test.png","Game Asset\\test2.png" )
player = Library.PLAYER("Game Asset\scroll_close_3.png", map_element_1.player_start)
players = pygame.sprite.GroupSingle(player)
buttons = pygame.sprite.Group()
run_buttons = pygame.sprite.Group()
turn_left_buttons = pygame.sprite.Group()
scroll_2 = pygame.sprite.Group(activate_surface, go_button, return_button, change_direct_button)
        ...
        if scene == "starting":
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                    ...
                    elif change_direct_button.rect.collidepoint(mouse):
                        get_drag = True
                        new_copy = Library.duplicate(change_direct_button)
                        turn_left_buttons.add(new_copy)
                        buttons.add(new_copy)
                    if buttons.sprites() != [] and compile_button.rect.collidepoint(mouse):
                        ...
                        for sprite in all_buttons:
                            ...
                            elif sprite in turn_left_buttons:
