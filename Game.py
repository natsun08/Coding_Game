...
compile_button = Library.ENVIRONMENT("Game Asset\\Art\\Sound_on.png", 1.5, "center", 810, 370)
mouse_sprite = Library.PLAIN_TILE((10, 10), "White", (0, 0))
new_copy = Library.PLAIN_TILE((20, 20), "White", (0, 0))

#GROUP
starting_environment = pygame.sprite.Group(sky_surface, cloud_1 , cloud_2,cloud_3, cloud_4 , Logo, scroll_close_brown)
...
while True:
    ...
    if is_sucess:
        ...
        if scene == "starting":
            ...
            starting_environment.update()
            starting_environment.draw(screen)
            cloud_1.animate(3)
            cloud_2.animate(-3)
            cloud_3.animate(4)
            cloud_4.animate(-2)
